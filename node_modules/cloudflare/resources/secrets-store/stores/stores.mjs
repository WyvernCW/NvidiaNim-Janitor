...
import { SecretCreateResponsesSinglePage, SecretListResponsesV4PagePaginationArray, Secrets, } from "./secrets.mjs";
...
export class Stores extends APIResource {
    ...
    create(params, options) {
        ...
        return this._client.post(`/accounts/${account_id}/secrets_store/stores`, {
            body,
            ...options,

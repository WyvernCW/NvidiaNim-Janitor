...
export declare class Secrets extends APIResource {
     ...
     * ```
     */
    bulkUpdate(dispatchNamespace: string, scriptName: string, params: SecretBulkUpdateParams, options?: Core.RequestOptions): Core.APIPromise<SecretBulkUpdateResponse>;
    /**
...
export type SecretBulkUpdateResponse = {
    [key: string]: SecretBulkUpdateResponse.WorkersBindingKindSecretText | SecretBulkUpdateResponse.WorkersBindingKindSecretKey;
};
export declare namespace SecretBulkUpdateResponse {
    interface WorkersBindingKindSecretText {
        /**
         * A JavaScript variable name for the binding.
         */
...
export interface SecretBulkUpdateParams {
     ...
     */
    secrets?: {
        [key: string]: SecretBulkUpdateParams.WorkersBindingKindSecretText | SecretBulkUpdateParams.WorkersBindingKindSecretKey | null;
    };
    /**
...
export declare namespace SecretBulkUpdateParams {
    interface WorkersBindingKindSecretText {
        /**
         * A JavaScript variable name for the binding.
         */

...
export declare class PrefixBindings extends APIResource {
    /**
     ...
     * ```
     */
    create(params: PrefixBindingCreateParams, options?: Core.RequestOptions): Core.APIPromise<PrefixBindingCreateResponse>;
    /**
     ...
     * ```
     */
    list(params: PrefixBindingListParams, options?: Core.RequestOptions): Core.PagePromise<PrefixBindingListResponsesCursorPagination, PrefixBindingListResponse>;
    /**
     ...
     * ```
     */
    delete(bindingId: string, params: PrefixBindingDeleteParams, options?: Core.RequestOptions): Core.APIPromise<PrefixBindingDeleteResponse>;
    /**
     ...
     * ```
     */
    edit(bindingId: string, params: PrefixBindingEditParams, options?: Core.RequestOptions): Core.APIPromise<PrefixBindingEditResponse>;
    /**
     ...
     * ```
     */
    get(bindingId: string, params: PrefixBindingGetParams, options?: Core.RequestOptions): Core.APIPromise<PrefixBindingGetResponse>;
}
export declare class PrefixBindingListResponsesCursorPagination extends CursorPagination<PrefixBindingListResponse> {
}

...
export declare class Objects extends APIResource {
     ...
     * ```
     */
    list(bucketName: string, params: ObjectListParams, options?: Core.RequestOptions): Core.PagePromise<ObjectListResponsesCursorPagination, ObjectListResponse>;
    /**
     ...
     * ```
     */
    delete(bucketName: string, objectKey: string, params: ObjectDeleteParams, options?: Core.RequestOptions): Core.APIPromise<ObjectDeleteResponse>;
    /**
     ...
     * ```
     */
    get(bucketName: string, objectKey: string, params: ObjectGetParams, options?: Core.RequestOptions): Core.APIPromise<Response>;
    /**
     ...
     * ```
     */
    upload(bucketName: string, objectKey: string, body: string | ArrayBufferView | ArrayBuffer | BlobLike, params: ObjectUploadParams, options?: Core.RequestOptions): Core.APIPromise<ObjectUploadResponse>;
}
export declare class ObjectListResponsesCursorPagination extends CursorPagination<ObjectListResponse> {
}
/**
...
export declare namespace ObjectListResponse {
    /**
     * HTTP metadata associated with an R2 object.
     */

...
export declare class Queries extends APIResource {
     ...
     * ```
     */
    list(params: QueryListParams, options?: Core.RequestOptions): Core.PagePromise<QueryListResponsesSinglePage, QueryListResponse>;
}
export declare class QueryListResponsesSinglePage extends SinglePage<QueryListResponse> {
}
...
export declare namespace QueryCreateResponse {
    ...
    namespace Parameters {
        ...
        interface WorkersObservabilityFilterLeaf {
             ...
             */
            operation: 'includes' | 'not_includes' | 'starts_with' | 'ends_with' | 'regex' | 'exists' | 'is_null' | 'in' | 'not_in' | 'eq' | 'neq' | 'gt' | 'gte' | 'lt' | 'lte' | '=' | '!=' | '>' | '>=' | '<' | '<=' | 'INCLUDES' | 'DOES_NOT_INCLUDE' | 'MATCH_REGEX' | 'EXISTS' | 'DOES_NOT_EXIST' | 'IN' | 'NOT_IN' | 'STARTS_WITH' | 'ENDS_WITH';
            /**
...
export declare namespace QueryListResponse {
    interface Parameters {
        /**
         * Create Calculations to compute as part of the query.
         */
...
export declare namespace QueryCreateParams {
    interface Parameters {
        /**
         * Create Calculations to compute as part of the query.
         */
...
export declare namespace Queries {
    export { type QueryCreateResponse as QueryCreateResponse, type QueryListResponse as QueryListResponse, QueryListResponsesSinglePage as QueryListResponsesSinglePage, type QueryCreateParams as QueryCreateParams, type QueryListParams as QueryListParams, };
}

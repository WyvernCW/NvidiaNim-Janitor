...
export declare namespace AccessRule {
    ...
    namespace AccessCloudflareAccountMemberRule {
        interface CloudflareAccountMember {
            /**
             * Identifier.
             */
            account_id?: string;

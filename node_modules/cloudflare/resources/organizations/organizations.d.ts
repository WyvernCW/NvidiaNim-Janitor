...
import * as OrganizationProfileAPI from "./organization-profile.js";
import { OrganizationProfile, OrganizationProfileResource, OrganizationProfileUpdateParams } from "./organization-profile.js";
...
export declare class Organizations extends APIResource {
     ...
     */
    list(query?: OrganizationListParams, options?: Core.RequestOptions): Core.PagePromise<OrganizationsSinglePage, Organization>;
...
export declare class OrganizationsSinglePage extends SinglePage<Organization> {
}
/**
...
export declare namespace OrganizationListParams {
...
export declare namespace Organizations {
    export { type Organization as Organization, type OrganizationDeleteResponse as OrganizationDeleteResponse, OrganizationsSinglePage as OrganizationsSinglePage, type OrganizationCreateParams as OrganizationCreateParams, type OrganizationUpdateParams as OrganizationUpdateParams, type OrganizationListParams as OrganizationListParams, };
    export { OrganizationProfileResource as OrganizationProfileResource, type OrganizationProfile as OrganizationProfile, type OrganizationProfileUpdateParams as OrganizationProfileUpdateParams, };
    export { Logs as Logs };
